...
export default function Sidebar({setIDE,setNoter}){
    ...
    return(
        <div className="sidebar">
            ...
            >
              ...
              <Tooltip title="Prepare Assessments">
              <BottomNavigationAction sx={{color:"white",marginBottom:3}}className="bottom-nav-icon" 
        icon={<PendingActionsIcon fontSize="medium"/>} />
              </Tooltip>
 
              <Tooltip title="Space">    
              <BottomNavigationAction  sx={{color:"white",marginBottom:3}} 
              className="bottom-nav-icon" icon={<ForumIcon fontSize="medium" />} />
              </Tooltip>
              <Tooltip title="Start Playground">
              <BottomNavigationAction onClick={()=>{
                  setIDE(true)
                  toast.success("Code editor started")
              }}sx={{color:"white",marginBottom:3}} className="bottom-nav-icon" icon={<TerminalIcon fontSize="medium"/>} />
          </Tooltip>
          <Tooltip title="Report">
              <BottomNavigationAction onClick={()=>{
               ...
               className="bottom-nav-icon"  icon={<NotesIcon fontSize="medium"/>} />
              </Tooltip>
            </BottomNavigation>
            </Box>
