...
export default function SideBarContent({setIDE}){
    ...
    return(
        <div className="sidebarcontent">
            ...
            >
              ...
              <BottomNavigationAction  onClick={setIDE(true)} sx={{color:"white",marginBottom:3}} className="bottom-nav-icon" icon={<TerminalIcon fontSize="medium"/>} />
          </Tooltip>
            </BottomNavigation>
            </Box>
